    ...
    <nav className='nav-wrapper'>
      ...
      <div className="nav-content">
        <ul className='list-styled'>
          ...
          <li>
            <a href="http://prathamesh-zad-profile.vercel.app/" target='_blank' className='link-styled'>Contact</a>
          </li>

          <li>
            <a href="http://prathamesh-zad-profile.vercel.app/" target='_blank'><img src={Search} alt="Search" /></a>
          </li>

          <li>
            <a href="https://github.com/Prathameshzad" target='_blank'><img src={Store} alt="Store" /></a>
          </li>
        </ul>
      </div>
